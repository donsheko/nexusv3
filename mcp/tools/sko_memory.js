const prisma = require("@sko/prisma/lib/prisma.js");
  ...
  handler: async (args) => {
    ...
    try {
      switch (action) {
        ...
        case "summary":
          // Upsert para el resumen de sesión del proyecto
          const sessionSummary = await prisma.memory.upsert({
            where: { id: id || "global-summary-placeholder" }, // Idealmente buscar por tipo 'summary' y project
