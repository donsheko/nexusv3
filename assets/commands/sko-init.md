...
15. **Creación del Blueprint**: Una vez definida la misión, crea manualmente el archivo `.md` dentro de la carpeta `.sko-specs/`.
...
16. **Delegación de Diseño**: Invocar al `@Arquitecto` mediante el comando `/sko-analyze` indicando la **ruta relativa completa** del archivo generado (ej: `.sko-specs/2024-05-10_fix-db.md`).
